...
function FileUpload({ className, cookie, refreshFunction }) {
    const [images, setImages] = useState([])

    const onDrop = (files) => {

        // 이미지를 ajax로 업로드 할 때, 페이지 전환없이 폼 데이터 제출하고 싶을 때 formData 객체 사용.
        ...
        UploadAPI.uploadImage(formData, config).then(res => {
